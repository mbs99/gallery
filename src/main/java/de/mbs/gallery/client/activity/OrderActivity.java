...
public class OrderActivity extends AbstractGalleryActivity<OrderPlace, OrderView> {
          ...
          new Callback<Gallery, String>() {
            ...
            public void onSuccess(Gallery result) {
              ...
              if (!EOrderState.OPEN.equals(EOrderState.safeParseValue(result.getOrderState()))) {
                clientFactory
                    .eventBus()
                    .fireEvent(new ChangeNavbarEvent(ENavbarType.READONLY_ORDER_VIEW));
              }
  ...
  protected void submitOrder() {
    ...
    if (null == orderState || EOrderState.OPEN.equals(orderState)) {
          ...
          new Callback<Void, String>() {
            ...
            public void onSuccess(Void result) {
              clientFactory
                  .galleryResources()
                  .submitOrder(
                      model.getGallery(place.getRole()),
                      new Callback<Void, String>() {
                              ...
                              .saveGallery(
                                  ...
                                  new Callback<Void, String>() {
                                    ...
                                    public void onSuccess(Void result) {
                                      ...
                                      clientFactory
                                          .placeController()
                                          .goTo(new CheckoutPlace(place.getRole()));
                                    }
                                  });
                        }
                      });
  ...
  private Gallery getGallery(String galleryName) {
    return model.getGallery(galleryName);
  }
